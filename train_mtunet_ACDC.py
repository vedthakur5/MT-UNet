...
parser.add_argument("--list_dir", default="ACDC_data/lists_ACDC")
parser.add_argument("--root_dir", default="ACDC_data/")
parser.add_argument("--volume_path", default="ACDC_data/test")
